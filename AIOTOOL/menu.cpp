...
ImFont* Main;
ImFont* FMenu;
float color_menu[4]{ 135 / 255.f, 53 / 255.f , 182 / 255.f, 1.0f };
char customtag[6] = "";
...
void cMenu::DrawMenu()
{
	...
	if (ImGui::Begin(" AIO TOOL", &g_vars->msettings.b_menuEnable, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_::ImGuiWindowFlags_AlwaysUseWindowPadding |
